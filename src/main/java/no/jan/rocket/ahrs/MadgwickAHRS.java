...
public class MadgwickAHRS {
    ...
    public MadgwickAHRS(double sampleFrequency) {
        this(sampleFrequency, 0.1d);
    }

    public MadgwickAHRS(double sampleFrequency, double beta) {
        this.sampleFrequency = sampleFrequency;
        this.beta = beta;               // 2 * proportional gain (Kp)
        q0 = 1; q1 = 0; q2 = 0; q3 = 0; // quaternion of sensor frame relative to auxiliary frame
    }


    public void update(double gx, double gy, double gz,
