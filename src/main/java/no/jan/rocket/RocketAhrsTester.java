...
public class RocketAhrsTester extends Application {
    ...
    MeshView rocketMeshView = GraphicsBuilder.createRocketMeshView();
...
//        cameraRotateZ.setAngle(25); // yaw
    ...
    private Group buildGroup() {
        ...
        group.getChildren().addAll(rocketMeshView, xAxis, yAxis, zAxis);
...
//                            double[] rotationMatrix = quat.get4x4RotationMadg();
                            ...
                            rocketMeshView.getTransforms().setAll(new Affine(rotationMatrix, MatrixType.MT_3D_4x4,0));
